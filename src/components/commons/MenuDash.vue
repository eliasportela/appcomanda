<template>
  <div>
    <nav class="w3-sidebar w3-collapse w3-white" style="z-index:1;width:300px;" id="mySidebar"><br>
      <div class="w3-container w3-center">
        <span><i class="fa fa-user fa-2x"></i> <strong>Elias Portela</strong></span><br>
      </div>
      <hr>
      ...
      <div class="w3-bar-block">
        ...
        <router-link to="a" class="w3-bar-item w3-button row-menu" active-class="w3-red"><i class="fa fa-cog fa-fw"></i>  Configurações (Indiponivel)</router-link><br><br>
      </div>
    </nav>
